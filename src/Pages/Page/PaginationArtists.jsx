...
const PaginationArtists = ({ totalPages, onPageChange }) => {
  const { artists = [], page, isLoading=true, error="" } = useSelector((state) => state.artists);
  ...
  const renderData = () => {
    ...
    return artists.slice(startIndex, endIndex).map((item, index) => (
