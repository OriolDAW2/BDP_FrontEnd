...
import { setPage } from "../../slices/songs/songSlice";

import "./css/PaginatePlaylist.css";

const PaginationSongs = ({ totalPages, onPageChange }) => {
  ...
  const renderData = () => {
    ...
    return songs.slice(startIndex, endIndex).map((item, index) => (
...
export default PaginationSongs;
